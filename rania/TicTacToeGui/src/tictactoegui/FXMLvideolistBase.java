...
public class FXMLvideolistBase extends AnchorPane {
    ...
    public FXMLvideolistBase() {
        ...
        label0.setLayoutY(219.0);
        label0.setText("Select the game:");
        ...
        choiceBox.setLayoutX(231.0);
        choiceBox.setLayoutY(297.0);
